				...
				<div class="container-login100-form-btn">
					<div class="wrap-login100-form-btn">
						<div class="login100-form-bgbtn"></div>
							<button onclick="location.href = 'trackpaper.php';"type="button" class="login100-form-btn"  >
					...
					<div class="wrap-login100-form-btn">
						<div class="login100-form-bgbtn"></div>
							<button onclick="location.href = 'trackelectronic.php';"type="button" class="login100-form-btn"  >
