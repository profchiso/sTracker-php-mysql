		...
		<div class="container-login100">
            ...
            <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                ...
                <span class="help-block"><?php echo $password_err; ?></span>
					...
					<div> <br />
					<div><b> <center> <a href="guest.php"> Guest? Track Document Here </a> </center></b>
						
					</div>
					<br />
						
					</div>
					<div><b> <center>If not registered or can't login, contact SmartTracker Administrator</center></b>
						
					</div>
<br /> <br />
            <p><center>If you are an admin <a href="admin.php">Login here</a>.</center></p>
				</form>
			</div>
		</div>
	</div>
