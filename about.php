    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form>
                    <div>
                        <h2 align=center> <a href="welcome.php">
                                <font color="blue" size=4>Go Back to DashBoard</font>
                            </a></h2>
                    </div> <br />
                    <div align=justify>
                        <p>This App was developed by Chibuike Madubuike Ezeocha in fulfilment for the award of Ph.D in
                            Computer Science. This is purely an academic research work and have been tested for academic
                            purposes. All Rights Reserved (2019). </p>
                    </div> <br />
                    <div>
                        <p>
