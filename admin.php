...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["password"]))){
	    ...
	    // Check if staff_no is admin
    if(trim($_POST["staff_no"]) != 'admin'){
        $staff_no_err = "you are not an Admin!";
    } else{
        $staff_no = trim($_POST["staff_no"]);
    }
...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
            ...
            <p><center>If you are NOT an admin <a href="index.php">Login here</a>.</center></p>
